/**
 * This plugin is no longer maintained by Ionic Plugin. So, created a copy
 */
import { CordovaInstance, InstanceProperty, Plugin, getPromise, InstanceCheck, checkAvailability, CordovaCheck, AwesomeCordovaNativePlugin } from '@awesome-cordova-plugins/core';
 ...
 *
 * ```typescript
 * import { Contacts, Contact, ContactField, ContactName } from '@awesome-cordova/contacts';
 *
