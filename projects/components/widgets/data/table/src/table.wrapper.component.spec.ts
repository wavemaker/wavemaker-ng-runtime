...
const quick_edit_markup = `<div wmTable wmTableFilterSort wmTableCUD #table_1 data-identifier="table" tabindex="0" editmode="quickedit"
                                name="UserTable1" title="User List" navigation="Basic"filtermode="search"  filteronkeypress="true" isdynamictable="false" rowselect.event="UserTable1Rowselect($event, widget, row)">
        ...
        describe("Editable", () => {
            ...
            describe("Quick Edit", () => {
                ...
                describe("Pagination", () => {
                    describe("Basic", () => {
                        // ADD COLUMNS STEP
                       it("should have pagination at the bottom", () => {
                            quick_edit_fixture.detectChanges();
                            const tablePaginationEl = quick_edit_fixture.nativeElement.querySelector(".app-datagrid-paginator");
                            expect(tablePaginationEl).toBeDefined();
                        });
                    });
                    describe("Pager", () => {
                        it("To Do", () => { });
