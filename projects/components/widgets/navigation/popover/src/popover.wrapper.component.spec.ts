...
describe('PopoverComponent', () => {
    ...
    let getAnchorEle = () => {
        return fixture.debugElement.query(By.css('[wmanchor]'));
    }
    ...
    it('should display caption as clickable', () => {
        getAnchorEle().nativeElement.widget.caption = 'clickable';
        fixture.detectChanges();
        expect(document.getElementsByClassName('anchor-caption')[0].innerHTML).toBe('clickable');
    })
  
    it('should show popover arrow ', () => {
        getAnchorEle().nativeElement.click();
        fixture.detectChanges();
    ...
    it('icon class should be applied', () => {
        getAnchorEle().nativeElement.widget.iconclass = "wi wi-star-border";
        fixture.detectChanges();
        expect(document.getElementsByClassName('app-icon').length).toBe(1);
    })

    it('icon position should be top', () => {
        getAnchorEle().nativeElement.widget.iconposition = "top";
        fixture.detectChanges();
    ...
    it('icon url should should show the image', () => {
        getAnchorEle().nativeElement.widget.iconurl = "https://therightsofnature.org/wp-content/uploads/2018/01/turkey-3048299_1920-1366x550.jpg";
        fixture.detectChanges();
    ...
    it('icon width , height and margin with icon class should be applied', () => {
        getAnchorEle().nativeElement.widget.iconclass = "wi wi-star-border";
        getAnchorEle().nativeElement.widget.iconwidth = "60px";
        getAnchorEle().nativeElement.widget.iconheight = "40px";
        getAnchorEle().nativeElement.widget.iconmargin = "4px";
        fixture.detectChanges();
    ...
    // it('should open the popover on mouse hover', async (() => {
        
    //     fixture.whenStable().then(() => {
    //         wmComponent.getWidget().interaction = 'hover';
    //         spyOn(popoverWrapperComponent,'onHover');
    //         getAnchorEle().nativeElement.dispatchEvent(new MouseEvent('mouseenter'));
    //         fixture.detectChanges();
