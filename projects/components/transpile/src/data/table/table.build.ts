...
function assignColumnIndex(node, parentIndex?: number) {
    ...
    node.forEach((childNode) => {
        ...
        if (nodeName === 'wm-table-column' || nodeName === 'wm-table-column-group') {
            (childNode as any).attrs.push(new Attribute('index', '' + columnIndex, <any>1, <any>1, <any>1, undefined, undefined));
            (childNode as any).attrs.push(new Attribute('headerIndex', '' + newheaderIndex, <any>1, <any>1, <any>1, undefined, undefined));
