...
const addFormControlName = (children = []) => {
    children.forEach(childNode => {
        ...
        if (formWidgets.has(childNode.name)) {
            ...
            childNode.attrs.push(new Attribute('formControlName', key, <any>1, <any>1, <any>1, undefined, undefined));
            childNode.attrs.push(new Attribute('wmFormWidget', '', <any>1, <any>1, <any>1, undefined, undefined));
        }
