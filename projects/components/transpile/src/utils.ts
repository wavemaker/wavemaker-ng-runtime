...
export const getDataTableFilterWidget = type => {
    ...
    if ([FormWidgetType.TEXT, FormWidgetType.NUMBER, FormWidgetType.SELECT, FormWidgetType.AUTOCOMPLETE,
        FormWidgetType.DATE, FormWidgetType.TIME, FormWidgetType.DATETIME].indexOf(widget) >= 0) {
        return widget;
    }
