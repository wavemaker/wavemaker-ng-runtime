...
export class SearchDemoComponent {
    ...
    private dataset: any[] = [
        { id: 1, name: 'Alabama', region: 'South', image: 'https://www.50states.com/images/redesign/seals/al-largeseal.png' },
    ...
    private displayimagesrc = 'image';

    private datafield = 'name';

    private orderby;

    private displaylabel: string = 'name + \' State\'';

    private datavalue: string = 'California';
