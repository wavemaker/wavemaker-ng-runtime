...
import { appManager, formatExportExpression, setInput, decodeData, metadataService } from './../../util/variable/variables.utils';
...
var ServiceVariableManager = /** @class */ (function (_super) {
    ...
    ServiceVariableManager.prototype.uploadFileInFormData = function (variable, options, success, error, file, requestParams) {
        var _this = this;
        var promise = upload(file, variable.httpService, requestParams.data, {
            fileParamName: 'files',
        ...
        promise.then(function (data) {
            ...
            var errMsg = variable.httpService.getErrMessage(e);
