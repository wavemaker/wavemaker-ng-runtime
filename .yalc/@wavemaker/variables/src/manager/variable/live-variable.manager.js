...
import { formatExportExpression, initiateCallback, setInput, appManager, formatDate } from '../../util/variable/variables.utils';
...
var LiveVariableManager = /** @class */ (function (_super) {
    ...
    LiveVariableManager.prototype.makeCall = function (variable, dbOperation, params) {
        ...
        var errorHandler = function (error, reject) {
            var errMsg = variable.httpService.getErrMessage(error);
