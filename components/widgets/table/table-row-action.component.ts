...
registerProps();
const WIDGET_CONFIG = {widgetType: 'wm-table-row-action', hasTemplate: true};

@Component({
    selector: 'wm-table-row-action',
    template: '<div><div>'
})
export class TableRowActionComponent extends BaseComponent {
    accessroles;
    action;
    caption;
    class;
