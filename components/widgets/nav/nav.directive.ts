import { Directive, ElementRef, Injector, ChangeDetectorRef, AfterViewInit, ViewContainerRef, ComponentFactoryResolver, OnInit } from '@angular/core';
import { BaseComponent } from '../base/base.component';
import { registerProps } from './nav.props';
import { addClass } from '@utils/dom';
import { styler, APPLY_STYLES_TYPE } from '../../utils/styler';
import { isObject, validateAccessRoles } from '@utils/utils';
